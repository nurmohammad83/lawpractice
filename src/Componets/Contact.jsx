  ...
  return (
    <div class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-800 text-gray-100">
      <div class="flex flex-col items-center justify-between">
        <div class="space-y-2">
          ...
          <div class="text-gray-400">
            We will contact you back in 5 hours max.
          </div>
        </div>
        <img
          src="https://i.ibb.co/fYff66D/contact-us-2993000-340.webp"
          alt=""
      ...
      <form novalidate="" class="space-y-6 ng-untouched ng-pristine ng-valid">
        ...
        <button
          type="submit"
          class="w-full p-3 text-sm font-bold tracking-wide uppercase rounded bg-green-500 text-white font-medium hover:bg-green-600"
        >
          Send Message
        </button>
      </form>
